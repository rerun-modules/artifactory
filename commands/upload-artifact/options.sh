...
# Created: Wed Jan 23 14:46:22 PST 2013
#
#/ usage: artifactory:upload-artifact [ --repo-url <http://artifactory.dev4.rms.com:8081/artifactory>]  --repo-id <>  --group-id <>  --artifact-id <>  --artifact-version <>  --artifact-format <>  --artifact-file <>  --repo-username <repository username to authenticate with>  --repo-password <> 
...
rerun_options_parse() {
    ...
    [ -z "$REPO_USERNAME" ] && REPO_USERNAME="$(rerun_property_get $RERUN_MODULE_DIR/options/repo-username DEFAULT)"
